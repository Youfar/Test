...
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/twitterDB?useSSL=false");
        dataSource.setUsername("twitteradmin");
        dataSource.setPassword("wyf314,./");
...
//    @Bean
//    public UserRepository userServiceImpl(){
//        return (UserRepository) new UserServiceImpl();
//    }
